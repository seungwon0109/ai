...
if "test_output_guard_removes_unknown_ids_and_downgrades_static_confirmation" not in text:
    marker = '''    def test_no_new_evidence_stops_second_step(self):
'''
    addition = '''    def test_output_guard_removes_unknown_ids_and_downgrades_static_confirmation(self):
...
print("Patched Qwen output guard tests.")
